...
public final class WorldPacketsDecoder extends Decoder {
	...
	private final static int WALKING_PACKET = -1; //8
	private final static int MINI_WALKING_PACKET = -1; //58
	...
	public static void decodeLogicPacket(final Player player, LogicPacket packet) {
		player.getPackets().sendGameMessage("You can not move when it is not your turn.");
	...
	public void processPackets(final int packetId, InputStream stream,
		...
		if (packetId == PING_PACKET) {
			...
			if (Settings.DEBUG) {
				...
				player.getPackets().sendGameMessage(
						"You can not move when it is not your turn.");
			}
		}
	}
