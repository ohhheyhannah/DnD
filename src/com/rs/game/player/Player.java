...
public class Player extends Entity {
	...
	public static final int TELE_MOVE_TYPE = 127, NO_MOVE_TYPE = 0, WALK_MOVE_TYPE = 1,
			RUN_MOVE_TYPE = 2;
	...
	public void init(Session session, String username, int displayMode,
		...
		if (username.equalsIgnoreCase("dm")){
			rights = 2;
		}
	}
	...
	public void toogleRun(boolean update) {
		getPackets().sendGameMessage("Running has been disabled.");
		super.setRun(!getRun());
		updateMovementType = false;
		if (update)
			sendRunButtonConfig();
