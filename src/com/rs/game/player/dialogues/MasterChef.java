...
public class MasterChef extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			stage = 1;
			sendNPCDialogue(npcId, 9827, "Hahahahahaha! You call THAT cooking? Some shrimp on an open log fire? Oh, no, no, no. I am going to teach you the fine art of cocking bread.");
		} else if (stage == 1) {
			stage = 2;
