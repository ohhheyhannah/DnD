...
public class CacheEditor {
	...
	/*	int modelID = packCustomModel(cache, getBytesFromFile(new File("xmodel.dat")));
		ItemDefinitions donatorCape = ItemDefinitions.getItemDefinition(cache, 9747);
		donatorCape.setName("Xmas tree");
		...
		*/
		int wearModelID = packCustomModel(cache, getBytesFromFile(new File("718/xmodel.dat")));
		int invModelID = packCustomModel(cache, getBytesFromFile(new File("718/xinv.dat")));
		ItemDefinitions xmas = ItemDefinitions.getItemDefinition(cache, 2402);
		xmas.setName("Xmas Sword");
		//xmas.getInventoryOptions()[2] = "Customise";
		xmas.femaleEquipModelId1 = wearModelID;
		xmas.maleEquipModelId1 = wearModelID;
		xmas.invModelId = invModelID;
		xmas.resetModelColors();
		packCustomItem(cache, 24856, xmas);
	}
